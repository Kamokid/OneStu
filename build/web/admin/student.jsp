                ...
                <header>
                    <div class="content">
                        ...
                        <div class="right">
                            <table>
                                <tr>
                                    <td><a href="<c:url value='/admin/student.jsp'/>">Personal Info</a></td>
                                    <td><a href="<c:url value='/admin/student.jsp'/>">Attendance</a></td>
                                    <td><a href="<c:url value='/admin/student.jsp'/>">Performance</a></td>
                                    <td><a href="<c:url value='/admin/student.jsp'/>">Fees</a></td>
                                </tr>
                            </table>
                            <br /><br /><br /><br /> 
